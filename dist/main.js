...
(function eventListeners() {
  ...
  document.querySelector(".testBtn").addEventListener("click", () => {
    console.log(_logic_js__WEBPACK_IMPORTED_MODULE_1__.LOGIC.allProjects);
  });
